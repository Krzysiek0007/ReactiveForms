              ...
              <form [formGroup]="applyForm" (ngSubmit)="submitApplication()">
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="text-danger small mt-1">
                      @if (birthday?.errors?.['invalidDate']) {
                      <div>Nieprawidłowa data.</div>
                      } @if (birthday?.errors?.['outOfRange']) {
                      <div>
                        Data musi być między {{ birthday?.errors?.['outOfRange']?.min }} a
                        {{ birthday?.errors?.['outOfRange']?.max }}.
                      </div>
                      }
                    </div>
                    }
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="text-danger small mt-1">
                      @if (growth?.errors?.['min']) {
                      <div>Wzrost musi być co najmniej 80 cm.</div>
                      } @if (growth?.errors?.['max']) {
                      <div>Wzrost nie może przekraczać 250 cm.</div>
                      }
                    </div>
                    }
                  </div>
